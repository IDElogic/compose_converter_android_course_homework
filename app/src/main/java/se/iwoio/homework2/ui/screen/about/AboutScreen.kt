package se.iwoio.homework2.ui.screen.about
...
fun AboutScreen(
    ...
    Card(
        ...
        Column(
            ...
            Column() {
                Button(onClick = {
                    val kgValue = numberText.toFloat()
                    textResult = (kgValue * 2.204).toString()
                }) {
                    Text(text = "kg -> pound")
                }
                Button(onClick = {
                    val lbValue = numberText.toFloat()
                    textResult = (lbValue * 0.453).toString()
                }) {
                    Text(text = "pound -> kg")
                }
